...
async function mainRunSequence(xlsxPath, seqPath) {
  ...
  /**
   * Updates the dropdown menus based on the specified resolution and chemical names.
   * @param {object} resolutionData The resolution data object.
   * @param {string} resolution The resolution ("1x1", "2x2", "3x3" or "4x4").
   * @param {object[]} dropdownData An array of objects representing each dropdown menu.
   * @param {string[]} chemNames An array of chemical names for populating the dropdown menus.
   */
